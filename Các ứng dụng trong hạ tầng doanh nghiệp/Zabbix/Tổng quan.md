...
Lợi ích của việc sử dụng angent là một giải pháp không yêu cầu bất kief cài đặt agent rieegn biết nào. Phân tích mạng dựa trên giám sát package tiếp. Nó được  sử dụng dể giám sát tính sẵn sàng của mạng và hiệu suất. Tuy nhiên, nó không cung cấp bất kì thông tin chi tiết nào về lỗi.

Dựa trên các giao thức SNMP hoặc WMI, được dựa trên một trạm quản lí trung tâm, giám sát tất cả các thiết bị mạng khác

Việc cài đặt không ảnh hưởng đến hiệu suất của server. Quá trình triển khai sẽ dễ dàng hơn, không phải thường xuyên cập nhật csc agent. Tuy nhiên lại không đi sâu thu thập được các số liệu, không cung cấp khả năng phân tích và báo cáo

Trong khi zabbix- agent cung caaso những tính năng tuyệt vời trên một số nền tảng, nhưng cũng có trường hợp có những nền tảng không thể cài đặt được nó, DỐi với trường hợp này, phương thức agentless được cung cấp với zavix server
